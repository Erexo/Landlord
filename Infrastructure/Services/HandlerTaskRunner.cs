...
{
    class HandlerTaskRunner : IHandlerTaskRunner
    {
        private readonly IHandler _handler;
        private readonly Func<Task> _validateAsync;
        private readonly ISet<IHandlerTask> _handlerTasks;

        public HandlerTaskRunner(IHandler handler, Func<Task> validateAsync,
        ...
        {
            HandlerTask handlerTask = new HandlerTask(_handler, runAsync, _validateAsync);
